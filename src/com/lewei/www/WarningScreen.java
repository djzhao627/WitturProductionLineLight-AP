				...
				case 1:
					...
					case 1:
						if (btn[2] == 1) {
							...
							if (red1) {
								dealWittturBtnWarningToLewei("AP;1");
							}
							red1 = false;
						}
						break;
					...
					case 4:
						if (btn[2] == 1) {
							...
							if (red2) {
								dealWittturBtnWarningToLewei("AP;2");
							}
							red2 = false;
						}
						break;
				...
				case 2:
					...
					case 1:
						if (btn[2] == 1) {
							...
							if (red3) {
								dealWittturBtnWarningToLewei("AP;3");
							}
							red3 = false;
						}
						break;
					...
					case 4:
						if (btn[2] == 1) {
							...
							if (red4) {
								dealWittturBtnWarningToLewei("AP;4");
							}
							red4 = false;
						}
						break;
				...
				case 3:
					...
					case 1:
						if (btn[2] == 1) {
							...
							if (red5) {
								dealWittturBtnWarningToLewei("AP;5");
							}
							red5 = false;
						}
						break;
					...
					case 4:
						if (btn[2] == 1) {
							...
							if (red6) {
								dealWittturBtnWarningToLewei("AP;6");
							}
							red6 = false;
						}
						break;
				...
				case 4:
					...
					case 1:
						if (btn[2] == 1) {
							...
							if (red7) {
								dealWittturBtnWarningToLewei("AP;7");
							}
							red7 = false;
						}
						break;
					...
					case 4:
						if (btn[2] == 1) {
							...
							if (red8) {
								dealWittturBtnWarningToLewei("AP;8");
							}
							isLost = true;
						} else {
							if (!yellow8 && !green8) {
